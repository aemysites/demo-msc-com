...
## Environments
- Preview: https://main--demo-msc-com--aemysites.aem.page/
- Live: https://main--demo-msc-com--aemysites.aem.live/
- Block Library: https://main--demo-msc-com--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `demo-msc-com` directory in your favorite IDE and start coding :)
